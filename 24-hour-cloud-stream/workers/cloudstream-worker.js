...
const ALLOWED_ORIGINS = [
  // AVENORA domains (Firebase Hosting for project avenora-6e147)
  'https://avenora-6e147.web.app',
  'https://avenora-6e147.firebaseapp.com',
  // Add custom AVENORA production domain below when live, e.g.:
  // 'https://avenora.app',
];
...
const CORS_HEADERS = {
  'Access-Control-Allow-Origin':  'https://avenora-6e147.web.app',
  'Access-Control-Allow-Methods': 'GET, POST, OPTIONS',
  'Access-Control-Allow-Headers': 'Content-Type, Authorization',
  'Access-Control-Max-Age':       '86400',
  'Vary':                         'Origin',
